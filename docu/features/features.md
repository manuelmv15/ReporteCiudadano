...
| RF-03 | Reporte Rápido (GPS) y Personalizado (Long Click)        | ✅      | Botón '+' agrega reporte en ubicación actual (GPS); Long Click en cualquier punto del mapa permite reportar en esa posición específica. Mira central eliminada para simplificar UX. |
